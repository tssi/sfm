...
<?php echo $this->Form->create('Ledger');?>
	<fieldset>
		<legend><?php __('Edit Ledger'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Ledger.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Ledger.id'))); ?></li>
