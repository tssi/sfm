...
<?php echo $this->Form->create('TuitionDiscount');?>
	<fieldset>
		<legend><?php __('Edit Tuition Discount'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('TuitionDiscount.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('TuitionDiscount.id'))); ?></li>
